...
function returnTen(str){
  ...
  let pointer = chars.length - 10;
  chars.splice(0,pointer);
  return chars;
...
const typeNum = (arr) => {
  ...
  let newArr = arr.filter( function(n,i) {
...
const filterStringsWithVowels = (arr) => {
  let newArr = arr.filter( function(n,i) {
    return (n.includes('a') || n.includes('e') || n.includes('i') || n.includes('o') || n.includes('u'));
  });
  return newArr;
